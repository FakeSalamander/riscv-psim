...
%My own packages and setups are included below
...
%renaming the "Listings" to match the List of Figures
...
\hypersetup{
	...
	filecolor=blue,
	citecolor=black,
    pdftitle={Hands-On Experience: A Pedagogical RISC-V Simulator},
