...
fn display_cpu(state: &Registers, logic: &Logic) {
    ...
    */
    ...
    println!("                                                                   ┌────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────\x1b[92m{:#07b}\x1b[0m────┐", state.memwb.rd_index);
    ...
    println!("│ │ ┌─\\     ┌──┐ │  │  Mem.  │     │     │ ┌►│Decoder├─\x1b[92m{:#07b}\x1b[0m───┐ │ └─►│Wb data      Reg1├─┬───►│R1   ├───\x1b[92m{:#010x}\x1b[0m─►│\x1b[93m{}\x1b[0m  │     │  └─/  ▼         │  │     │   │                  │     │ │ └►│\x1b[93m{}\x1b[0m │  │ │", logic.decode.decode_r1, state.idex.r1_data, if logic.execute.r1_forwarded == 0 {"►"} else {" "}, if logic.writeback.wb_used == 2 {"►"} else {" "});
    println!("│ └►│\x1b[93m{}\x1b[0m │    │PC│ │  │        │     │     │ │ │       │           │ │    │                 │ │    │ Data│ │             │   │     │     ┌─────────┐ │  │     │   │                  │     │ │   │  │  │ │", if !logic.fetch.jumped {"►"} else {" "});
    println!("│   │  ├─┬─►│  ├─┼─►│addr    │     │     │ │ │       ├─\x1b[92m{:#07b}\x1b[0m─┐ │ └───►│Wb idx           │ │    │     │ │ ┌───EX-EX──►└{}─/      │     │Op1      │ │  │     │   │  ┌──────────┐    │     │ └─┬►│\x1b[93m{}\x1b[0m ├──┘ │", logic.decode.decode_r2, if logic.execute.r1_forwarded == 1 {"\x1b[93m►\x1b[0m"} else {"─"}, if logic.writeback.wb_used == 0 {"►"} else {" "});
    ...
    println!("                                   │     │             └────────────\x1b[92m{:#07b}\x1b[0m─────────────────────►│Rd Id├───────┐               ├────────\x1b[92m{:#010x}\x1b[0m───►│Mem  ├─┴────\x1b[92m{:#010x}\x1b[0m      │     │             │", logic.decode.decode_rd, logic.execute.formux_r2, state.exmem.mem_data_in);
    println!("                                   │     │                                                       │     │   │   │               │ │                    │  In │   │                  │     │             │");
    println!("                                   │     │                                                       │     │   │   │               │ │  ┌─────────┐       │     │   │                  │     │             │");
    println!("                                   │     │                                                       │     │   │   │               │ └─►│ Branch? │       │     │   │                  │     │             │");
    println!("                                   │     │                                                       │     │   │   │               │    │         │       │     │   │                  │     │             │");
    ...
    println!("                                   │     │                                                       │     │   │   │                    └─────────┘       │     │   │                  │     │             │");
    println!("                                   │     │                                                       │     │   │   │                                      │     │   │                  │     │             │");
    println!("                                   │     │                                                       │     │   │   └────────────\x1b[92m{:#07b}\x1b[0m──────────────────►│Rd Id├────────\x1b[92m{:#07b}\x1b[0m──────►│Rd In├─────────────┘", state.idex.rd_index, state.exmem.rd_index);
    println!("                                   └─────┘                                                       └─────┘   │                                          └─────┘   │                  └─────┘              ");
