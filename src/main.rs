...
fn main() {
    ...
    //CPU SETUP: Initializes the state and logic structs.s
...
fn display_cpu(state: &Registers, logic: &Logic) {
    ...
    */
    ...
    println!("                                                                   ┌────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────\x1b[92m$r{:#02}\x1b[0m───────┐", state.memwb.rd_index);
    ...
    println!(
        "\x1b[93m-IF:{}---------------ID:{}-----------------------EX:{}-------MEM:{}-------WB:{}-------\x1b[0m",
        if_instr, id_instr, ex_instr, mem_instr, wb_instr
    );
    println!("                                                                   │ ┌───────────────────────────────────┬───────────────────────────────────────────────────────────────────────────────\x1b[92m{:#010x}\x1b[0m──┐ │", logic.writeback.wb_data);
    println!("                                                                   │ │                                   │                                                                                           │ │");
    println!("┌──────\x1b[92m{:#010x}\x1b[0m──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┐                                                 │ │", logic.execute.alu_output);
    println!("│                                                                  │ │                                   │                                         │                                                 │ │");
    println!("│ ┌─────────────────────┐          ┌─────┐                         │ │                           ┌─────┐ │                                         │  ┌─────┐                      ┌─────┐           │ │" );
    println!("│ │                     │          │IF/ID│                         │ │                           │ID/EX│ │                                         │  │ EX/ │                      │ MEM │           │ │");
    println!("│ │         ┌─┐    ┌─\\  │\x1b[92m{:#010x}\x1b[0m│     │                         │ │                           │     │ │                                         │  │ MEM │                      │ /WB │           │ │", logic.fetch.pcadder_out);
    println!("│ │         │4├───►│  │ │    │     │     │                         │ │                           │     │ │                                         │  │     │                      │     │           │ │");
    println!("│ │         └─┘    │+ ├─┴────┴────►│added├─\x1b[92m{:#010x}\x1b[0m───────────────────────────────────────────►│added├───\x1b[92m{:#010x}\x1b[0m────────────────────────────────►│added├───────\x1b[92m{:#010x}\x1b[0m────►│added├───┐       │ │",state.ifid.added_pc, state.idex.added_pc, state.exmem.added_pc);
    println!("│ │              ┌►│  │            │  pc │                         │ │                           │  pc │ │                                         │  │  pc │                      │  pc │   │       │ │");
    println!("│ │              │ └─/             │     │                         │ │                           │     │ │                                         │  │     │                      │     │\x1b[92m{:#010x}\x1b[0m │ │", state.memwb.added_pc);
    println!("│ │              │                 │     │                         │ │                           │     │ │ ┌─\x1b[92m{:#010x}\x1b[0m───────────┐                │  │     │                      │     │   │       │ │", state.idex.base_pc);
    println!("│ │              ├────────────────►│base ├─\x1b[92m{:#010x}\x1b[0m───────────────────────────────────────────►│base ├───┘                      │ ┌─\\            │  │     │                      │     │   │       │ │", state.ifid.base_pc);
    println!("│ │              │                 │  pc │                         │ │                           │  pc │ │             ┌──\\       └►│\x1b[93m{}\x1b[0m │           │  │     │   ┌───\x1b[92m{:#010x}\x1b[0m────►│ALU  ├─┐ │ WB    │ │", if logic.execute.pc_used {"►"} else {" "} ,state.exmem.alu_output);
    println!("│ │ PC           │  ┌────────┐     │     │                         │ │  ┌─────────────────┐      │     │ ├────MEM-EX──►│\x1b[93m{}\x1b[0m  │        │  ├─┐         │  │     │   │                  │  Out│ │ │ Mux.  │ │", if logic.execute.r1_forwarded == 2 {"►"} else {" "});
    println!("│ │ Mux.         │  │ Instr. │     │     │   ┌───────┐             │ │  │  Register Mem.  │      │     │ │             │ R1├─────┬─►│\x1b[93m{}\x1b[0m │ │         │  │     │   │                  │     │ │ │ ┌─\\   │ │", if !logic.execute.pc_used {"►"} else {" "});
    println!("│ │ ┌─\\     ┌──┐ │  │  Mem.  │     │     │ ┌►│Decoder├─\x1b[92m$r{:#02}\x1b[0m──────┐ │ └─►│Wb data      Reg1├─┬───►│R1   ├───\x1b[92m{:#010x}\x1b[0m─►│\x1b[93m{}\x1b[0m  │     │  └─/  ▼         │  │     │   │                  │     │ │ └►│\x1b[93m{}\x1b[0m │  │ │", logic.decode.decode_r1, state.idex.r1_data, if logic.execute.r1_forwarded == 0 {"►"} else {" "}, if logic.writeback.wb_used == 2 {"►"} else {" "});
    println!("│ └►│\x1b[93m{}\x1b[0m │    │PC│ │  │        │     │     │ │ │       │           │ │    │                 │ │    │ Data│ │             │   │     │     ┌─────────┐ │  │     │   │                  │     │ │   │  │  │ │", if !logic.fetch.jumped {"►"} else {" "});
    println!("│   │  ├─┬─►│  ├─┼─►│addr    │     │     │ │ │       ├─\x1b[92m$r{:#02}\x1b[0m────┐ │ └───►│Wb idx           │ │    │     │ │ ┌───EX-EX──►└{}─/      │     │Op1      │ │  │     │   │  ┌──────────┐    │     │ └─┬►│\x1b[93m{}\x1b[0m ├──┘ │", logic.decode.decode_r2, if logic.execute.r1_forwarded == 1 {"\x1b[93m►\x1b[0m"} else {"─"}, if logic.writeback.wb_used == 0 {"►"} else {" "});
    println!("└──►│\x1b[93m{}\x1b[0m │ │  │  │ │  │     ins├─┬──►│instr├─┤ │       │         │ │      │                 │ │    │     │ │ │                     │     │         │ │  │     │   │  │ DATA MEM.│    │     │   │ │  │    │", if logic.fetch.jumped {"►"} else {" "});
    println!("    └─/  │  └──┘ │  └────────┘ │   │     │ │ │ opcode├───┐     │ └─────►│R1 idx           │ │    │     │ └──────MEM-EX──►┌{}─\\    │     │   ALU   │ │  │     │   │  │      Read├─┬─►│Mem  ├─┬──►│\x1b[93m{}\x1b[0m │    │", if logic.execute.r2_forwarded == 2 {"►"} else {"─"}, if logic.writeback.wb_used == 1 {"\x1b[93m►\x1b[0m"} else {" "});
    println!("         │ {} │             │   │     │ │ │       │   │     │        │                 │ │    │     │   │             │   │   │     │      Out├─┼─►│ALU  ├───┼──┤Addr   Out│ │  │  Out│ │ │ └─/     │", if logic.pc_stall { "STALL" } else {"PASS "});
    println!("         │       │             │   │     │ │ │ rd idx├─┐ │     └───────►│R2 idx       Reg2├───┬─►│R2   ├─────\x1b[92m{:#010x}\x1b[0m─►│\x1b[93m{}\x1b[0m  │   │     │Op2      │ │  │  Out│   │  │          │ │  │     │ │ │         │", state.idex.r2_data, if logic.execute.r2_forwarded == 0 {"►"} else {" "});
    println!(" \x1b[92m{:#010x}\x1b[0m   \x1b[92m{:#010x}\x1b[0m       │   │     │ │ └───────┘ │ │              └─────────────────┘ │ │  │ Data│   │             │ R2├─┐ │     └─────────┘ │  │     │   │  │          │ │  │     │ │\x1b[92m{:#010x}\x1b[0m │", logic.fetch.pcmux_out, state.pc, state.memwb.alu_output);
    println!("                               │   │     │ │           │ │ ┌──────┐                \x1b[92m{:#010x}\x1b[0m │  │     │   ├─────EX-EX──►│\x1b[93m{}\x1b[0m  │ │ │  ┌─\\  ▲         │  │     │ ┌────┤DataIn    │ │  │     │ │           │", logic.decode.regmem_r1, if logic.execute.r2_forwarded == 1 {"►"} else {" "});
    println!("                      \x1b[92m{:#010x}\x1b[0m   │     │ │           │ └►│ Imm. │                           │  │     │   │             └──/  ├───►│\x1b[93m{}\x1b[0m │ │ \x1b[92m{:#010x}\x1b[0m │     │ │ │  └──────────┘ │  │     │\x1b[92m{:#010x}\x1b[0m   │", logic.fetch.instruction_out,if !logic.execute.imm_used {"►"} else {" "} ,logic.execute.alu_output, state.memwb.mem_data_out);
    println!("                                   │     │ │           │   │Decode│                  \x1b[92m{:#010x}\x1b[0m  │     │   │                   │ │  │  ├─┘            │     │ │ │  \x1b[93m{}\x1b[0m     │  │     │             │", logic.decode.regmem_r2, if logic.memory.memmem_fwd {"MEM-MEM!"} else {"        "});
    println!("                                   │     │ ├──────────────►│      ├─\x1b[92m{:#010x}\x1b[0m─┐                 │     │   │ ┌─\x1b[92m{:#010x}\x1b[0m──────────►│\x1b[93m{}\x1b[0m │              │     │ │ │      \x1b[92m{:#010x}\x1b[0m  │     │             │", logic.decode.immediates, state.idex.immediates, if logic.execute.imm_used {"►"} else {" "}, logic.memory.mem_data_out );
    println!("                                   │     │ │           │   └──────┘            └────────────────►│Imms.├─────┘                 │ │  └─/               │     │ │ │                  │     │             │");
    println!("                                   │     │ \x1b[92m{:#010x}\x1b[0m  │                                         │     │   │                   │ │                    │     │ │ │                  │     │             │", state.ifid.instruction);
    println!("                                   │     │             └────────────\x1b[92m$r{:#02}\x1b[0m────────────────────────►│Rd Id├───────┐               ├────────\x1b[92m{:#010x}\x1b[0m───►│Mem  ├─┴────\x1b[92m{:#010x}\x1b[0m      │     │             │", logic.decode.decode_rd, logic.execute.formux_r2, state.exmem.mem_data_in);
    println!("                                   │     │                                                       │     │   │   │               │ │                    │  In │   │                  │     │             │");
    println!("                                   │     │                                                       │     │   │   │               │ │  ┌─────────┐       │     │   │                  │     │             │");
    println!("                                   │     │                                                       │     │   │   │               │ └─►│ Branch? │       │     │   │                  │     │             │");
    println!("                                   │     │                                                       │     │   │   │               │    │         │       │     │   │                  │     │             │");
    ...
    println!("                                   │     │                                                       │     │   │   │                    └─────────┘       │     │   │                  │     │             │");
    println!("                                   │     │                                                       │     │   │   │                                      │     │   │                  │     │             │");
    println!("                                   │     │                                                       │     │   │   └────────────\x1b[92m$r{:#02}\x1b[0m─────────────────────►│Rd Id├────────\x1b[92m$r{:#02}\x1b[0m─────────►│Rd In├─────────────┘", state.idex.rd_index, state.exmem.rd_index);
    println!("                                   └─────┘                                                       └─────┘   │                                          └─────┘   │                  └─────┘              ");
    ...
    println!("                                                                                                           └─\x1b[92m{:#010x}\x1b[0m─────────────────────────────────────────┘                                      ", state.exmem.alu_output);
